...
function ConnectViewGalleryLifestyle({ data, selectOverlaySlider, showHover = true, expand = true }) {
...
export default connect(mapStateToProps, mapDispatchToProps)(ConnectViewGalleryLifestyle);